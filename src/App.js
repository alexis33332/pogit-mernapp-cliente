...
const addFriend = () => {
  Axios.post("https://crud-mer.herokuapp.com/addFriend", {
    name : name,
    age : age,
...
const updateFriend = (id) => {
  ...
  Axios.put("https://crud-mer.herokuapp.com/update", { newAge: newAge, newDescription : newDescription, id : id}).then(() => {
...
const deleteFriend = (id) =>{
  Axios.delete(`https://crud-mer.herokuapp.com/delete/${id}`).then(()=>{
  ...
  useEffect(() => {
    Axios.get("https://crud-mer.herokuapp.com/read")
    .then((response) => {
